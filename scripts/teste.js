/*
 Primeiro declarar as constantes no codigo;

 Segundo achar um method de validar o regexp para o input, aceitando apenas um caractere

 Terceiro apos ser validado ele devera 
